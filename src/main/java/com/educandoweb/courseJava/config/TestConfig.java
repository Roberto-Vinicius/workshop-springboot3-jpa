...
import com.educandoweb.courseJava.repositories.OrderItemRepositiry;
...
public class TestConfig implements CommandLineRunner {
	...
	@Autowired
	private OrderItemRepositiry orderItemRepositiry;
	...
	public void run(String... args) throws Exception {
		...
		User u3 = new User(null, "Roberto Vinicius", "roberto@gmail.com", "977777777", "141516"); 
		
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), OrderStatus.PAID, u1);
		Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), OrderStatus.WAITING_PAYMENT, u2);
		Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), OrderStatus.WAITING_PAYMENT, u1);
		
		userRepositiry.saveAll(Arrays.asList(u1, u2, u3));
